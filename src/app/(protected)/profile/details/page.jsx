          ...
          <div className="p-6 sm:p-10 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <div className="text-slate-900 font-medium break-all">{user.email}</div>
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <div className="text-slate-900 font-medium">{user.mobile || "N/A"}</div>
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 md:col-span-2">
                    ...
                    <div className="text-slate-900 font-medium">{user.address || "N/A"}</div>
                </div>
            </div>
                ...
                {resetStep === "idle" && (
                    <div>
                        <p className="text-slate-600 text-sm mb-4">
                            Send a verification code to your email ({user.email}) to change your password.
                        </p>
                        <button
                ...
                {resetStep === "sent" && (
                     <form onSubmit={handleResetPassword} className="space-y-4 max-w-sm">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                type="button"
                                onClick={() => { setResetStep("idle"); setResetMsg(""); }}
            ...
            <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100 relative overflow-hidden">
                ...
                <p className="text-indigo-700 text-sm mb-6 max-w-lg">
                    Share your unique referral code with friends. When they sign up using your code, you'll both get rewards!
                </p>
            ...
            {user.referredBy && (
                <div className="text-center text-sm text-slate-400">
                    You were referred by user with code: <span className="font-mono text-slate-500">{user.referredBy}</span>
                </div>
            )}
